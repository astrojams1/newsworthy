...
appearance override (including share sheet and alerts), the iOS widget's own
Appearance setting (Light and Dark held against the opposite system mode), the notification switch
