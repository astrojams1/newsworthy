...
4. Finalize the same development’s sentence without changing its facts or score.
   Prompt v16 allows 135 characters for the body and reserves 5 for the label.
...
App-made ratings use the same v16 body budget and the existing generation-then-
